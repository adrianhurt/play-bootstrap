...
object BSVersion {
  final val code = "1.0-P23-B3"
  final val library = "1.0"
  final val play = "Play 2.3"
  final val play_code = "2.3"
  final val bootstrap = "Bootstrap 3"
  final val bootstrap_code = "3"

  final val repositoryBase = "master/play23-bootstrap3/module"
  ...
  final val msgsName = "lang"
  final val msgsClass = "Lang"
