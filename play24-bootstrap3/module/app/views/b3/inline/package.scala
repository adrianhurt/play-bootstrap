...
package object inline {
  ...
  def formCSRF(action: Call, args: (Symbol, Any)*)(body: InlineFieldConstructor => Html)(implicit token: play.filters.csrf.CSRF.Token) =
    views.html.b3.formCSRF(action, args: _*)(body(fieldConstructorSpecific))(fieldConstructorSpecific, token)
