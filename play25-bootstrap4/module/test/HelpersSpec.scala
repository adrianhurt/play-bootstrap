...
object HelpersSpec extends Specification {
  ...
  "@multifield" should {
    ...
    "show label" in {
      multifield(fooForm, Seq('_label -> "fooLabel"))(vfc, messages) must contain("<label>fooLabel</label>")
    ...
    "render validation states" in {
      ...
      "with feedback icons" in {
        testStatus("success", withFieldsArgs = false, '_showIconValid -> true)
        testStatus("success", withFieldsArgs = true, '_showIconValid -> true)
        testStatus("success", withFieldsArgs = false, '_success -> "test-help", '_showIconValid -> true)
        testStatus("success", withFieldsArgs = true, '_success -> "test-help", '_showIconValid -> true)
        testStatus("warning", withFieldsArgs = false, '_showIconWarning -> true)
        testStatus("warning", withFieldsArgs = true, '_showIconWarning -> true)
        testStatus("warning", withFieldsArgs = false, '_warning -> "test-help", '_showIconWarning -> true)
        testStatus("warning", withFieldsArgs = true, '_warning -> "test-help", '_showIconWarning -> true)
        testStatus("danger", withFieldsArgs = false, '_error -> true, '_showIconOnError -> true)
        testStatus("danger", withFieldsArgs = true, '_error -> true, '_showIconOnError -> true)
        testStatus("danger", withFieldsArgs = false, '_error -> "test-help", '_showIconOnError -> true)
        testStatus("danger", withFieldsArgs = true, '_error -> "test-help", '_showIconOnError -> true)
      }
    }
