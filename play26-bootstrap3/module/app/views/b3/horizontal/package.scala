...
package object horizontal {
  ...
  case class HorizontalFieldConstructor(colLabel: String, colInput: String) extends B3FieldConstructor {
    ...
    def apply(fieldInfo: B3FieldInfo, inputHtml: Html)(implicit msgsProv: MessagesProvider) = bsFieldConstructor(fieldInfo, inputHtml, colLabel, colOffset, colInput)(msgsProv)
